...
function getTotalByEstadoId($id){
  $sql = " SELECT proyectos.proyecto_id,proyectos.cuenta,alcance, inicio, detalle, objetivo_estrategico, presupuesto_inicial, estado_neural, estado, area, descripcion, SUM(presupuesto) AS total ";
  $sql .= " FROM proyectos ";
