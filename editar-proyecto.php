          ...
          <div class="col-12 col-sm-8">
            ...
            echo '</pre'; */
              ...
              <form class="form-horizontal" role="form" name="guardar-registro" id="guardar-registro-archivo" method="post" action="modelo-proyecto.php" enctype="multipart/form-data">
                ...
                <div class="col-sm-10">
                        <textarea class="form-control" rows="3" id="objetivo_estrategico" name="objetivo_estrategico" placeholder="Objetivo" required ><?php echo $proyecto['objetivo_estrategico'] ?></textarea>
                ...
                <div class="col-sm-10">
                        <textarea class="form-control" rows="3" id="alcance" name="alcance" placeholder="Alcance del proyecto" required> <?php echo $proyecto['alcance'] ?></textarea>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="presupuesto_inicial" name="presupuesto_inicial" placeholder="Presupuesto Inicial" required value="<?php echo $proyecto['presupuesto_inicial'] ?>" required pattern = "^[0-9]\d*(\.\d+)?$">
                    </div>
                  </div>
